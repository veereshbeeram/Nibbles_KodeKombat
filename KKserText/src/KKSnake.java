...
public class KKSnake {
    ...
    private KKLocation step() {
        switch (dir) {
            ...
            case 3:
                return new KKLocation(body.getLast().i - 1, body.getLast().j);
            default:
                System.out.println("Not Supported direction " + dir);
                return new KKLocation(body.getLast().i, body.getLast().j + 1);
        }
    }

    public void move(int i, int j, int map[][]) {
    	System.out.println("Size of body: " + body.size());
        ...
        System.out.println("Size of body at the end: " + body.size());
    }
    ...
    public void crash(int map[][]) {
        ...
        System.out.println("Bot " + this.id + " has crashed into some obstacle or another bot");
    }
