...
public class KKGame extends Thread {
    ...
    public KKGame(KKArena arenaModel,int tottime, KKBotManager botMang, KKArenaComponent arenaComp) {
    ...
    //    try {
            ...
            System.out.println("Kode kombat game simulation has begun.");
            ...
            try {
                ...
                out.write(String.valueOf(arenaComp.height));
                out.write("\n");
                out.write(String.valueOf(arenaComp.width));
                out.write("\n");
                out.write("1\n");
                for(int l=0;l<arenaComp.height; l++)
                {
                	for(int m = 0; m< arenaComp.width; m++)
                	{
	                ...
	                if (time_fastfood != null) {
	                    for (int i = 0; i < time_fastfood.length; i++) {
	                        if (currtime == time_fastfood[i]) {
	                            ...
	                            while (!done) {
	                                int ti = (int) (rand.nextDouble() * arenaComp.height);
	                                int tj = (int) (rand.nextDouble() * arenaComp.width);
	...
	//                map[i][j] = 1;
            ...
            System.out.println("Kode kombat game simulation has ended.");
            this.close();
